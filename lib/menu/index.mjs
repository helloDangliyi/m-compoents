import { defineComponent as x, resolveComponent as c, openBlock as r, createBlock as v, mergeProps as H, withCtx as h, createElementBlock as s, Fragment as p, renderList as z, resolveDynamicComponent as f, unref as w, createCommentVNode as m, createElementVNode as e, toDisplayString as g, createStaticVNode as y, useAttrs as B, createVNode as d, isVNode as L } from "vue";
const $ = (t) => t.replace(/(A-Z)g/, "-$1").toLocaleLowerCase(), A = /* @__PURE__ */ x({
  __name: "index",
  props: {
    data: {
  ...
  setup(t) {
    return (n, l) => {
      ...
      return r(), v(_, H({
        ...
        default: h(() => [
          (r(!0), s(p, null, z(t.data, (u, M) => (r(), s(p, { key: M }, [
            !u[t.children] || !u[t.children].length ? (r(), v(o, {
              key: 0,
              index: u[t.index]
            }, {
              default: h(() => [
                u[t.icon] ? (r(), v(f(`el-icon-${w($)(u[t.icon])}`), { key: 0 })) : m("", !0),
                e("span", null, g(u[t.name]), 1)
              ]),
              _: 2
            }, 1032, ["index"])) : (r(), v(a, {
              key: 1,
              ...
              default: h(() => [
                (r(!0), s(p, null, z(u[t.children], (C, V) => (r(), v(o, {
                  key: V,
                  index: C[t.index]
                }, {
                  default: h(() => [
...
const k = (t, n) => {
  ...
  for (const [o, a] of n)
    l[o] = a;
  return l;
}, b = /* @__PURE__ */ k(A, [["__scopeId", "data-v-a49f7fe4"]]);
...
const mM = /* @__PURE__ */ x({
  ...
  setup(t, n) {
    let l = (a) => a.map((_) => {
      _.i = fM[_[t.icon]];
      let u = {
        title: () => d(p, null, [d(_.i, null, null), d("span", null, [_[t.name]])])
      };
